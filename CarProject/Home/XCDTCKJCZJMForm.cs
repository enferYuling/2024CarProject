...
namespace CarProject.Home
{
    public partial class XCDTCKJCZJMForm : Form
    {
        ...
        private void zdph_btn_Click(object sender, EventArgs e)
        {
            ...
            ZDPH("192.168.2.253", 1030, zdph_btn.Tag.ToString());
        }
        private async void ZDPH(string ioip, int ioport, string type)
        {
            string ipaddress = ioip;
            int port = ioport;
        ...
        private void dtck_btn_Click(object sender, EventArgs e)
        {
            ...
            //try
            //{
            //    string processName = "DYDTCK";

            //    // 找到所有匹配的进程
            //    Process[] processes = Process.GetProcessesByName(processName);

            //    // 遍历并关闭每个找到的进程
            //    foreach (Process processnew in processes)
            //    {
            //        try
            //        {
            //            processnew.Kill(); // 关闭进程
            //            processnew.WaitForExit(); // 等待进程退出
            //        }
            //        catch (Exception ex)
            //        {
            ...
            //}
            //string consoleAppPath = "E:\\项目\\2024CarProject\\DYDTCK\\DYDTCK\\bin\\x64\\Debug\\DYDTCK.exe";
        ...
        private void XCDTCKJCZJMForm_Load(object sender, EventArgs e)
        {
            this.Focus();
            ClosedEXE1();
        ...
        {
            NET_DVR_USER_LOGIN_INFO SDK = method.GetSPZSX("192.168.2.64", "8000", "admin", "Admin123");
        ...
        private void XCDTCKJCZJMForm_Click(object sender, EventArgs e)
        {
            
        }
        public void ClosedEXE1()
        {
            try
            {
                string processName = "DYDTCK";
        ...
        private void dyt_img_Click(object sender, EventArgs e)
        {
        ...
        private void XCDTCKJCZJMForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ClosedEXE1();
        }
    }
