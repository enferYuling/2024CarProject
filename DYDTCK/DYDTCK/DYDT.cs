...
namespace DYDTCK
{
    public partial class DYDT : Form
    {
        public DYDT()
        {
            InitializeComponent();
            ...
            DT_Panel.Controls.Add(renderWindowControl1);
        }
        ...
        public async Task  lddt()
        {
            ...
            //ofd.ShowDialog();
            // 服务器文件的URL
            //uploads (file://NXCL2024/uploads)
            string serverUrl = "http://8.137.119.17:82/uploads/GlobalMap.txt";
           
            string localFilePath = Directory.GetCurrentDirectory()+ "\\uploads\\GlobalMap.txt";
       ...
       极大值位置设置为（255，0，0）*/
        ...
        private void DYDT_Load(object sender, EventArgs e)
        {
